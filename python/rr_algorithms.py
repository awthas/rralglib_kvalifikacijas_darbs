...
def run_algorithm(data, fs, algorithm="default", args=None):
    ...
    try:
        if algorithm == "default":
            rr, peaks = find_peaks_fast(data=data, fs=fs, args=args)
        elif algorithm == "find_peaks":
            rr, peaks = find_peaks_fast(data=data, fs=fs, args=args)
        elif algorithm == "cwt":
            rr, peaks = cwt_peaks_custom(data=data, fs=fs, args=args)
        elif algorithm == "cwt_oa":
            rr, peaks = cwt_peaks_oa(data=data, fs=fs, args=args)
        elif algorithm == "srmac":
            rr, peaks = srmac_inline(data=data, fs=fs, args=args)
        elif algorithm == "terma":
            rr, peaks = terma_corrected(data=data, fs=fs, args=args)
...
def sqi_visual(peaks, raw_signal, max_interval=None):
...
def find_peaks_fast(data, fs, window_size=None, prominence=None, heval_ratio=None, width=None, proximity=None, args=None):
    """
...
def srmac_inline(data, fs, window_size=None, coef_fast=None, coef_slow=None, coef_cross=None, threshold=None, width=None, margin=None, args=None): 
    """
...
def terma_corrected(data, fs, window_size=None, window_event=None, window_cycle=None, b_coef=None, width=None, margin=None, args=None):
    """
...
def cwt_peaks_custom(data, fs, window_size=None, resolution=None, threshold=None, width=None, margin=None, min_freq=None, max_freq=None, kernel_size=None, args=None):
    """
